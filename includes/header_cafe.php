			...
			<?php
				...
				<section class="divtable">
					<section class="divtablerow">
						<aside class="divtablecell" style="width:  15%;">

						<article><p align="center">منوی کافه<hr width="100%"></p><p align="center">
							نوشیدنی ها(این منو شامل نوشیدنی های گرم و نوشیدنی های سرد است) </p> 
							<p align="center" >کیک</p>
							<p  align="center">ابمیوه</p>
							<p  align="center">بستنی</p>
							</article>
						</aside>
						<article class="divtablecell" style="width: 85%;">